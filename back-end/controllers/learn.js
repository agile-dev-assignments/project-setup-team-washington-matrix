...
learnRouter.get('/checkmates/smothered', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
...
learnRouter.get('/checkmates/backrank', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
...
learnRouter.get('/checkmates/scholars', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
...
learnRouter.get('/checkmates/fools', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
...
learnRouter.get('/checkmates/kqmate', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
...
learnRouter.get('/checkmates/tworooks', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
...
learnRouter.get('/checkmates/krmate', async (req, res, next) => {
    res.json({
        data: {
            pieceInfo:
